...
#' @docType data
#' @keywords datasets
#' @usage data(politicalGoals)
#' @format An atomic named vector of length 4! = 24
#' @author The first reference
#' @references Barnes, S. H. and Kaase, M. (1979). \emph{Political Action: Mass Participation in Five Western Countries}. Sage, Beverly Hills, CA.
#' @references Croon, M. A. (1998). Latent class models for the analysis of rankings. \emph{New Developments in Psychological Choice Modeling}, 99--121. Feger, Klauer, and de Soete, eds. North-Holland, Amsterdam.
NULL